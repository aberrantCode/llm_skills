...
**Problem:** The agent may forget schema details mid-session - wrong column names, missing fields, incorrect types. TDD catches this at runtime, but we can prevent it earlier.
...
*Auto-generated or manually maintained. Agent: READ THIS before database work.*
...
Before writing any database code, The agent MUST:
