...
2. **Gather Context** (use tools, don't ask yet):
   - Search the codebase for similar features using file and text search tools
   - Identify relevant existing components, services, and data models
   - Understand current architecture patterns from AGENTS.md and existing feature docs
   - Check for related API endpoints, UI components, database tables

3. **Ask Clarifying Questions**:
   - Ask 3-4 strategic questions that will help you create a better spec
...
4. **Create Initial Draft**:
   ...
   - Follow project conventions (hexagonal architecture, canonical models, API standards)
   - Match the quality and depth of existing feature specs in `docs/features/`
...
**Key Principles**:
- **Iterative**: Ask clarifying questions at each major decision point
...
**Your First Action**: Ask the user 3-4 clarifying questions to understand:
